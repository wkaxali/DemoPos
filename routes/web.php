...
Route::get('/printsse/{ID}/{adv}/{month}/{year}',[printSalarySlip::class, 'printsalarySlip']);
...
Route::get('/printSoldStockData',[OrderFlowController::class, 'printSoldStockData']);
...
Route::get('/getAccounts',[accountsController::class, 'getAccountsWithNumbers']);
