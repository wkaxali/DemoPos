...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul>
                    <li>Documents of above mentioned vehicle are submitted for registration in Excise and Taxation
                        Department.</li>
                    <li>This certificate allows vehicle to move on above mentioned location without any disturbance of
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-5 offset-md-2 text-right">
                    <label for="">Authorized Stamp & Signature</label>
                    <input type="text" style="border-left:none; border-top: none; border-right: none;" name="" id="">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <p class="text-center">8-Km, Sheikhupura Road, Opposite Millat Tractors Limited, Lahore, Tel:
                        0300-0600061 <br>
                        Email Address: forlandmodernmotors@yahoo.com</p>
                </div>
            </div>
