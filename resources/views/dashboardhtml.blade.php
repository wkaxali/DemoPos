        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    <li id="menu-academico"><a href="/l"><i class="fas fa-user-circle"></i><span>Quotation</span><span
                    ...
                    <li id="menu-academico"><a href="/l"><i class="fas fa-user-circle"></i><span>Transfer</span><span
                                class="fa fa-angle-right" style="float: right"></span></a>
                        <ul id="menu-academico-sub">
                            <li id="menu-academico-boletim"><a href="/l">Investor Ledger</a></li>
                            <li id="menu-academico-avaliacoes"><a href="/igl">Investor General Ledger</a></li>
                    ...
                    <li id="menu-academico"><a href="/l"><i class="fas fa-user-circle"></i><span>Return</span><span
                                class="fa fa-angle-right" style="float: right"></span></a>
                        <ul id="menu-academico-sub">
                            <li id="menu-academico-boletim"><a href="/l">Investor Ledger</a></li>
                            <li id="menu-academico-avaliacoes"><a href="/igl">Investor General Ledger</a></li>
