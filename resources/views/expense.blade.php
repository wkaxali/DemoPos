                ...
                <div class="col-md-12">
                    <div class="row borderCustom-2">
                        <div class="col-md-5 offset-md-1">
                            ...
                            <input type="number" value="43360" name="" id="">
                            <h5>From Dec 25 to Jan 20</h5>
                        </div>
                        <div class="col-md-4 offset-md-2">
                            <h5>Your Expenses</h5>
                            <input type="number" value="50000" name="" id="">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" style="display: inline-block; width: 192px;"
            ...
            <div class="row">
                <div class="col-md-6 offset-md-6">
                    <div class="mainTableEnd">
                        ...
                        <input type="number" onclick="calculatonInTable()" value="" name="" id="mainTotal">
                    </div>
                </div>
            </div>
        </div>
