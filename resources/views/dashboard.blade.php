...
/* Magnific Popup CSS */
        ...
        ::-webkit-scrollbar-thumb {
            background-color: rgb(234 184 77);
        }
    ...
    <style>
        ...
        .btn-my {
            border: 1px solid rgb(234 184 77);
            background: none;
            padding: 10px 20px;
            font-size: 20px;
                            ...
                            <div class="col-md-6 chart-layer2-right">
                                <div class="prograc-blocks">
                                    ...
                                    <div class='bar_group'>
                                        ...
                                        <div class='bar_group__bar myBlueColor thin' style="background: #000000;"
                                        ...
                                        <div class='bar_group__bar thin' style="background: #000000;" label='Farming'
