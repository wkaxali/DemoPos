            ...
            <div class="inner-block">
                            ...
                            <div class="col-md-12">
                                <div class="row EmpRow">
                                    ...
                                    <div class="col-md-5" id="divName">
                                        ...
                                        <select class="selectpicker form-control" data-live-search="true" id="name"
                                            onchange="getByID()">
                ...
                <section class="PayDetailsSection">
                    <div class="container">
                        ...
                        <div class="row EmpRow">
                            <div class="col-md-4 payRow ">
                                <h4 class="redBg">Pay Details</h4>
                                <label for="">Basic Pay</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name="" id="basicPay"
                                    onchange="payCalculation()">
                                <br>
                                <label for="">Total Allowances</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="allownces" readonly>
                                <br>
                                <label for="">Comission %</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="comission" onchange="payCalculation()">
                                <br>
                                <label for="">Allowed Holidays</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="allowedHolidays" onchange="payCalculation()">
                                <br>
                                <label for="">Target Sales</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="saleTarget" onchange="payCalculation()">
                                <br>
                                <label for="">Working Hours</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="workingHours" onchange="payCalculation()">
                                <br>
                                <label for="">Reporting Time</label>
                                <input type="time" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name=""
                                    id="reportingTime" onchange="payCalculation()">
                                <br>
                                <label for="">Total Pay</label>
                                <input type="number" class="form-control" value=""
                                    style="display: inline-block; width: 200px; margin-top: 10px;" name="" id="total"
                                    readonly>

                                <div class="updateButtons" style="margin-top: 10px;">
                                    <button class="btn" onclick="updatePay()">Update</button>
                                </div>
                            </div>
                            <div class="col-md-4 payRow-1 ">
                                ...
                                <div class="common">
                                    ...
                                    <input readonly type="text"
                                        style="display: inline-block;width: 150px; margin-top: 10px;"
                                        class="form-control" id="totalSales">
                                    <br>
                                    ...
                                    <input readonly type="text"
                                        style="display: inline-block;width: 150px; margin-top: 10px;"
                                        class="form-control" id="absents">
                                    <br>
                                    <label for="">Absents Deductions</label>
                                    <input readonly type="text"
                                        style="display: inline-block;width: 150px;margin-top: 10px;"
                                        class="form-control" id="absentdeduction">
                                    <br>
                                    <label for="">Month Salary</label>
                                    <h1 style="display: inline-block;width: 150px;margin-top: 10px;" id="monthSalary">0
                                    </h1><br>
                            ...
                            <div class="col-md-4 payRow-1 ">
                                <h4 class="greenBg">Payable</h4>
                                <div class="common">
                                    <label for="">Total Payable</label>
                                    <h1 style="display: inline-block;width: 150px;" id="payable">0</h1>
                                    <br>

                                    <label for="">Date</label>
                                    <input type="date" style="display: inline-block;width: 150px;margin-top: 10px;"
                                        class="form-control" id="paymentDate">
                                    <br>
                                    <label for="">Amount Paid</label>
                                    <input onchange="calRemaining()" type="number"
                                        style="display: inline-block;width: 150px;margin-top: 10px;"
                                        class="form-control" id="amountPaid">
                                    <br>
                                    <label for="">Paid by</label>
                                    <select class="form-control" data-live-search="true" id="paidBy"
                                        style="display: inline-block;width: 150px;margin-top: 10px;">
                                    ...
                                    <input readonly type="text"
                                        style="display: inline-block;width: 150px;margin-top: 10px;"
                                        class="form-control" id="amountRemaining">
                                    <br>
                                    <label for="">Remarks</label>
                                    <input type="text" style="display: inline-block;width: 150px;margin-top: 10px;"
                                        class="form-control" id="remarks">
                                    <div class="updateButtons" style="margin-top: 30%;">
                                        <button onclick="paySalary()"
                                            class="btn">Update</button>
                                        <button onclick="printSalary()" class="btn">Print
                                            Salary</button>
                                    </div>
                                </div>
                            </div>
