                ...
                <div class="container">
                    <div class="row" id="selectFirst">
                        <div class="col-xl-3  col-lg-6 col-md-6   okay-invo">
                            ...
                            <button class="btn" style="height: 25px; margin-top: -5px; background-color:#efc55f;"
                            ...
                            <div class="centhour">
                                <button class="btn" style="background-color: #efc55f;">New</button>
                                <button class="btn" style="background-color: #000;">Edit</button>
                                <button class="btn" style="background-color: #efc55f;">Delete</button>
                            </div>
                        ...
                        <div class="col-md-6  okay-invo-1">
                            <div class="o-inv">
                                ...
                                <input type="text" class="form-control" style="display: inline-block;  height: 30px;"
                                    name="invo-1" id="CID">
                                <button class="btn"
                                    style="height: 25px; margin-top: -5px; background-color: #efc55f;"></button>
                                <br>
                                <label for="prod-1">Last Balance</label>
                                <input type="text" class="form-control" style="display: inline-block;  height: 30px;"
                                    name="invo-1" id="LastBalance">
                                <button class="btn"
                                    style="height: 25px; margin-top: -5px;background-color: #000000;"></button> <br>
                            ...
                            <div class="inv-bor-btns">
                                <button class="btn" style="background-color: #efc55f;" data-toggle="modal"
                                ...
                                <button class="btn" style="background-color: #efc55f;">History</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 okay-invo-3">
                            ...
                            <div class="total-buttons" id="hideme">
                                <button class="btn" style="background-color: #efc55f;"
                                    onclick="insertInSales()">Save</button>
                                <button class="btn" style="background-color: #000000;">Print</button>
                                <button class="btn" style="background-color: #efc55f;">Edit</button>
                            </div>
                            <div class="total-buttons" id="hideme">
                                <button class="btn" style="background-color: #000000;">Hold</button>
                                <button class="btn" style="background-color: #efc55f;">Update</button>
