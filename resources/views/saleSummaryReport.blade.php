                            ...
                            <div class="registration-form">
                                ...
                                <form>
                                    ...
                                    <div class="CustomerAddition  mb-3" style="margin-top:-20px !important;">
                                        <h2 class="text-center addCut">Summary Report</h2>

                                    </div>

                                    <div class="expenseButtons">
                                        <label style="width: 100px !important;" for="">From</label>
                                        <input type="date" style="display: inline-block !important; width: 200px;"
                                        class="form-control" name="" id="dateFrom"><br>

                                    </div>
                                    <div class="expenseButtons">
                                        <label style="width: 100px !important;" for="">To</label>
                                        <input type="date" style="display: inline-block !important; width: 200px;"
                                        class="form-control" name="" id="dateTo"><br>

                                    </div>
                      

                                    <div class="form-group" style="text-align: center;">
                                        <button type="button" class="btn  create-account" onclick="createReport()">Create Report</button>
                                    </div>
